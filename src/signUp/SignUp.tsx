...
import Rectangle from "../Component/Images/Rectangle 2.jpg";
import googleIcon from "../Component/Images/goggle.svg";
...
interface PhoneInputgState {
	phone: string;
}

export class PhoneInputg extends Component<{}, PhoneInputgState> {
	constructor(props: {}) {
		super(props);
		this.state = { phone: "" };
	}
			...
			<SignUpContainer>
				...
				<form>
					<div className="formDiv">
						...
						<input type="text" className="inputField" placeholder="Sandra" value={formData.firstName} onChange={handleInputChange} name="firstName" />

						<label htmlFor="" className="labelText">
							Surname
						</label>
						<input type="text" className="inputField" placeholder="Bloyd" value={formData.surname} onChange={handleInputChange} name="surname" />
