...
import { editReserveUnitSchema } from "../utils/reserveUnitShema";
...
const EditReserveUnitPage = () => {
  const { unitId, reservationId } = useParams();
  ...
  // const [unit, setUnit] = useState({}) as Record<string, any>;
  ...
  useEffect(() => {
    ...
    const formattedMinDate = formattedDate(currentDate);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const responseUnit = await axiosInstance.get(`api/unit/${unitId}`);
        setUnit(responseUnit.data.unit);

        const response = await axiosInstance.get(
          `/api/single-reservations/${reservationId}`
        );

        setReservationDetails((prevDetails) => ({
          ...prevDetails,
          ...response.data.reservation,
          checkInDate: formatDate(response.data.reservation.checkInDate),
          checkOutDate: formatDate(response.data.reservation.checkOutDate),
        }));
      } catch (error) {
...
const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  setReservationDetails((prevData) => ({
    ...prevData,
    [name]: value,
  }));
  ...
  const handleCustomerPhoneChange = (isValid: boolean, value: string) => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      setLoading(true);
      await editReserveUnitSchema.validate(reservationDetails, {
        abortEarly: false,
      });
      ...
      await axiosInstance.put(`/api/update-reservation/${reservationId}`, body);
  ...
  return (
    ...
    <>
      <BodyContainer>
        <CenteredDiv>
          <Motherdiv>
            <ReserveUnitHeading>Edit Reservation</ReserveUnitHeading>
            <AdditionalText>Edit Reserved Short-lets Units</AdditionalText>
          </Motherdiv>
          <Card>
             <ImageContainer >
              <ImagedivImportant >
            ...
            <Formcontainer>
              ...
              <form onSubmit={handleSubmit} method="post">
                ...
                >
                  ...
                  <div className="label">
                    <label htmlFor="customerEmail" className="email">
                ...
                >
                  <div style={{ position: "relative", marginBottom: "12px" }}>
                    ...
                    <InputImportant>
                      <IntlTelInput
                        onPhoneNumberChange={handleCustomerPhoneChange}
                ...
                {/* <div style={{ margin: "auto", marginBottom: "25px" }}>
                  ...
                  <Input>
                    <input
                      ...
                      onChange={handleInputChange}
                      defaultValue={reservationDetails.price}
                    />
                  </Input>
                </div> */}
              </form>
...
export default EditReserveUnitPage;